...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [Layer_main] = LAYOUT_ergodox_pretty(
    ...
    KC_LCTL,            KC_LALT,        LCTL(LSFT(KC_LGUI)),LCTL(KC_LGUI),  LSFT(KC_LGUI),                                                                                                  KC_LEFT,        KC_DOWN,        KC_UP,          KC_RIGHT,       QK_LEAD,
                                                                                                    ...
                                                                                                    LSFT(KC_PRINT_SCREEN),KC_PRINT_SCREEN,                  KC_PAGE_UP, KC_PAGE_DOWN,
                                                                                                                        KC_HOME,                            ST_MACRO_VIM_wq,
                                                        LT(Layer_symbols,KC_BACKSPACE),LGUI_T(KC_DELETE),           LCTL(KC_SPACE),                         LSFT_T(KC_ESCAPE),              LT(Layer_macros,KC_ENTER), KC_SPACE
  ),
  ...
  [Layer_mac_main] = LAYOUT_ergodox_pretty(
    ...
    KC_LGUI,            KC_LALT,        LCTL(LSFT(KC_LGUI)),LCTL(KC_LGUI),  LSFT(KC_LGUI),                                                                                                  KC_LEFT,        KC_DOWN,        KC_UP,          KC_RIGHT,       QK_LEAD,
                                                                                                    ...
                                                                                                    LSFT(KC_PRINT_SCREEN),LCTL(LGUI(LSFT(KC_4))),           KC_PAGE_UP, KC_PAGE_DOWN,
                                                                                                                        KC_HOME,                            ST_MACRO_VIM_wq,
                                                    LT(Layer_mac_symbols,KC_BACKSPACE),LCTL_T(KC_DELETE),           LCTL(KC_SPACE),                         LSFT_T(KC_ESCAPE),              LT(Layer_macros,KC_ENTER), KC_SPACE
  ),
  ...
  [Layer_symbols] = LAYOUT_ergodox_pretty(
    ...
    KC_MS_BTN4,         KC_EXLM,        LSFT(KC_2),         LSFT(KC_3),                 KC_DLR,             KC_PERC,                                                            KC_ASTR,        KC_LBRC,        KC_RBRC,        KC_UNDS,        KC_QUES,        _______,
    KC_LSFT,            ST_M_n_equal,   KC_AMPR,            LSFT(KC_NONUS_BACKSLASH),   LSFT(KC_NONUS_HASH),KC_ASTR,            KC_CIRC,                        _______,        KC_AMPR,        KC_LCBR,        KC_RCBR,        KC_DOT,         KC_NONUS_BACKSLASH,KC_LSFT,
    LALT(KC_LCTL),      ST_M_n_equal_2, LCTL(KC_X),         LCTL(KC_C),                 LCTL(KC_V),                                                                                             LSFT(KC_9),     LSFT(KC_0),     ST_M_l_equal,   ST_M_g_equal,   KC_LALT,


                                                                                                                    _______,_______,                        _______, _______,
                                                                                                                            _______,                        _______,
                                                                                        _______, _______,                   _______,                        LSFT(KC_SEMICOLON),                KC_NONUS_HASH,  KC_SEMICOLON
  ),
  ...
  [Layer_mac_symbols] = LAYOUT_ergodox_pretty(
    ...
    KC_MS_BTN4,         KC_EXLM,        LSFT(KC_QUOTE),     LSFT(KC_3),             KC_DLR,             KC_PERC,                                                            KC_ASTR,        KC_LBRC,        KC_RBRC,        KC_UNDS,        KC_QUES,        _______,
    KC_LSFT,            ST_M_n_equal,   KC_AMPR,            LSFT(KC_NONUS_HASH),    LSFT(KC_GRAVE),     KC_ASTR,            KC_CIRC,                        _______,        KC_AMPR,        KC_LCBR,        KC_RCBR,        KC_DOT,         KC_NONUS_HASH,  KC_LSFT,
    LALT(KC_LCTL),      ST_M_n_equal_2, LGUI(KC_X),         LGUI(KC_C),             LGUI(KC_V),                                                                                             LSFT(KC_9),     LSFT(KC_0),     ST_M_l_equal,   ST_M_g_equal,   KC_LALT,


                                                                                                                    _______,_______,                        _______, _______,
                                                                                                                            _______,                        _______,
                                                                                        _______, _______,                   _______,                        LSFT(KC_SEMICOLON),                LALT(KC_3),     KC_SEMICOLON
  ),
...
//  ST_M_led_timeout_30s,   _______,        _______,            DYN_REC_START1, DYN_REC_START2,   DYN_REC_STOP,   ST_M_colemak_mode_toggle,                         _______,  _______,        ST_M_brightness_down,           ST_M_brightness_up,     _______,                    _______,                  RESET,
    ...
    ST_M_led_timeout_1m,    ST_M_vim_q,     ST_M_vim_w,         _______,        LCTL(KC_V),       LCTL(KC_B),     _______,                                  KC_KB_VOLUME_UP,  _______,        ST_M_hue_down,                  ST_M_hue_up,            _______,                    ST_M_password_bypass,     ST_M_enable_bunny_hop,
  ...
  [Layer_gaming] = LAYOUT_ergodox_pretty(
    ...
    KC_LSFT,            KC_LSFT,        KC_X,               KC_C,           KC_V,           KC_G,           KC_ENTER,                                       KC_F5,          KC_KP_ENTER,    KC_KP_1,        KC_KP_2,        KC_KP_3,        KC_UP,          TO(Layer_main),
    KC_LCTL,            KC_Z,           KC_I,               KC_C,           KC_B,                                                                                                           KC_KP_0,        KC_KP_DOT,      KC_LEFT,        KC_DOWN,        KC_RIGHT,
